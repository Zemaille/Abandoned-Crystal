...
MapGroup_Dungeons:
	...
	map IlexForestHeart, TILESET_FOREST, CAVE, LANDMARK_ILEX_FOREST, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_POND
	...
	map DarkCaveMoltresChamber, TILESET_DARK_CAVE, CAVE, LANDMARK_DARK_CAVE, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_LAKE
	...
	map CianwoodCave1F, TILESET_DARK_CAVE, CAVE, LANDMARK_CIANWOOD_CAVE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_SHORE
	map CianwoodCave2F, TILESET_DARK_CAVE, CAVE, LANDMARK_CIANWOOD_CAVE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_SHORE
	map CianwoodCave3F, TILESET_DARK_CAVE, CAVE, LANDMARK_CIANWOOD_CAVE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_SHORE
	map DragonsDenB2F, TILESET_DARK_CAVE, CAVE, LANDMARK_DRAGONS_DEN, MUSIC_DRAGONS_DEN, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_DRATINI
	...
	map CeruleanCave1F, TILESET_DARK_CAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_SHORE
	map CeruleanCave2F, TILESET_DARK_CAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_SHORE
	map CeruleanCaveB1F, TILESET_DARK_CAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_SHORE
	map ViridianForest, TILESET_FOREST, CAVE, LANDMARK_VIRIDIAN_FOREST, MUSIC_NATIONAL_PARK, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SaltmarshArea1, TILESET_PARK, ROUTE, LANDMARK_OLIVINE_SALTMARSH, MUSIC_NATIONAL_PARK, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map SaltmarshArea2, TILESET_PARK, ROUTE, LANDMARK_OLIVINE_SALTMARSH, MUSIC_NATIONAL_PARK, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map SaltmarshArea3, TILESET_PARK, ROUTE, LANDMARK_OLIVINE_SALTMARSH, MUSIC_NATIONAL_PARK, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map SaltmarshArea4, TILESET_PARK, ROUTE, LANDMARK_OLIVINE_SALTMARSH, MUSIC_NATIONAL_PARK, FALSE, PALETTE_AUTO, FISHGROUP_POND
...
MapGroup_Cinnabar:
	...
	map SeafoamIslands1F, TILESET_DARK_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_SHORE
	map SeafoamIslandsB1F, TILESET_DARK_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_SHORE
	map SeafoamIslandsB2F, TILESET_DARK_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_SHORE
	map SeafoamIslandsB3F, TILESET_DARK_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_SHORE
	map SeafoamIslandsB4F, TILESET_DARK_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_SHORE
