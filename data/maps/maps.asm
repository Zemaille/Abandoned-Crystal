...
; pointers to the first map of each map group
	...
	dw MapGroup_PokeChampionClub ; 27
...
MapGroup_Olivine:
	...
	map OlivineCity, TILESET_JOHTO, TOWN, LANDMARK_OLIVINE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_OLIVINECITY
...
MapGroup_Mahogany:
	...
	map Route42, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_42, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_ROUTE42
	map Route44, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_44, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_ROUTE44
...
MapGroup_Dungeons:
	...
	map RuinsOfAlphOutside, TILESET_JOHTO, ROUTE, LANDMARK_RUINS_OF_ALPH, MUSIC_UNION_CAVE, FALSE, PALETTE_AUTO, FISHGROUP_RUINSOFALPH
	map RuinsOfAlphHoOhChamber, TILESET_RUINS_OF_ALPH, DUNGEON, LANDMARK_RUINS_OF_ALPH, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_RUINSOFALPH
	map RuinsOfAlphKabutoChamber, TILESET_RUINS_OF_ALPH, DUNGEON, LANDMARK_RUINS_OF_ALPH, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_RUINSOFALPH
	map RuinsOfAlphOmanyteChamber, TILESET_RUINS_OF_ALPH, DUNGEON, LANDMARK_RUINS_OF_ALPH, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_RUINSOFALPH
	map RuinsOfAlphAerodactylChamber, TILESET_RUINS_OF_ALPH, DUNGEON, LANDMARK_RUINS_OF_ALPH, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_RUINSOFALPH
	map RuinsOfAlphInnerChamber, TILESET_RUINS_OF_ALPH, DUNGEON, LANDMARK_RUINS_OF_ALPH, MUSIC_RUINS_OF_ALPH_INTERIOR, TRUE, PALETTE_DAY, FISHGROUP_RUINSOFALPH
	map RuinsOfAlphResearchCenter, TILESET_FACILITY, INDOOR, LANDMARK_RUINS_OF_ALPH, MUSIC_UNION_CAVE, FALSE, PALETTE_DAY, FISHGROUP_RUINSOFALPH
	map RuinsOfAlphHoOhItemRoom, TILESET_RUINS_OF_ALPH, DUNGEON, LANDMARK_RUINS_OF_ALPH, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_RUINSOFALPH
	map RuinsOfAlphKabutoItemRoom, TILESET_RUINS_OF_ALPH, DUNGEON, LANDMARK_RUINS_OF_ALPH, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_RUINSOFALPH
	map RuinsOfAlphOmanyteItemRoom, TILESET_RUINS_OF_ALPH, DUNGEON, LANDMARK_RUINS_OF_ALPH, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_RUINSOFALPH
	map RuinsOfAlphAerodactylItemRoom, TILESET_RUINS_OF_ALPH, DUNGEON, LANDMARK_RUINS_OF_ALPH, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_RUINSOFALPH
	map RuinsOfAlphHoOhWordRoom, TILESET_HO_OH_WORD_ROOM, DUNGEON, LANDMARK_RUINS_OF_ALPH, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_RUINSOFALPH
	map RuinsOfAlphKabutoWordRoom, TILESET_KABUTO_WORD_ROOM, DUNGEON, LANDMARK_RUINS_OF_ALPH, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_RUINSOFALPH
	map RuinsOfAlphOmanyteWordRoom, TILESET_OMANYTE_WORD_ROOM, DUNGEON, LANDMARK_RUINS_OF_ALPH, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_RUINSOFALPH
	map RuinsOfAlphAerodactylWordRoom, TILESET_AERODACTYL_WORD_ROOM, DUNGEON, LANDMARK_RUINS_OF_ALPH, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_RUINSOFALPH
	map UnionCave1F, TILESET_CAVE, CAVE, LANDMARK_UNION_CAVE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_UNIONCAVE
	map UnionCaveB1F, TILESET_CAVE, CAVE, LANDMARK_UNION_CAVE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_UNIONCAVE
	map UnionCaveB2F, TILESET_CAVE, CAVE, LANDMARK_UNION_CAVE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_UNIONCAVE
	map SlowpokeWellB1F, TILESET_CAVE, CAVE, LANDMARK_SLOWPOKE_WELL, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_SLOWPOKEWELL
	map SlowpokeWellB2F, TILESET_CAVE, CAVE, LANDMARK_SLOWPOKE_WELL, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_SLOWPOKEWELL
	...
	map IlexForest, TILESET_FOREST, CAVE, LANDMARK_ILEX_FOREST, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_ILEXFOREST
	map IlexForestHeart, TILESET_FOREST, CAVE, LANDMARK_ILEX_FOREST, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_ILEXFOREST
	...
	map MountMortar1FOutside, TILESET_DARK_CAVE, CAVE, LANDMARK_MT_MORTAR, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_MOUNT_MORTAR
	map MountMortar1FInside, TILESET_DARK_CAVE, CAVE, LANDMARK_MT_MORTAR, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_MOUNT_MORTAR
	map MountMortar2FInside, TILESET_DARK_CAVE, CAVE, LANDMARK_MT_MORTAR, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_MOUNT_MORTAR
	map MountMortarB1F, TILESET_DARK_CAVE, CAVE, LANDMARK_MT_MORTAR, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_MOUNT_MORTAR
	...
	map IcePathDepths, TILESET_ICE_PATH, CAVE, LANDMARK_ICE_PATH, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
	map WhirlIslandNW, TILESET_DARK_CAVE, CAVE, LANDMARK_WHIRL_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_WHIRLISLANDS
	map WhirlIslandNE, TILESET_DARK_CAVE, CAVE, LANDMARK_WHIRL_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_WHIRLISLANDS
	map WhirlIslandSW, TILESET_DARK_CAVE, CAVE, LANDMARK_WHIRL_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_WHIRLISLANDS
	map WhirlIslandCave, TILESET_DARK_CAVE, CAVE, LANDMARK_WHIRL_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_WHIRLISLANDS
	map WhirlIslandSE, TILESET_DARK_CAVE, CAVE, LANDMARK_WHIRL_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_WHIRLISLANDS
	map WhirlIslandB1F, TILESET_DARK_CAVE, CAVE, LANDMARK_WHIRL_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_WHIRLISLANDS
	map WhirlIslandB2F, TILESET_DARK_CAVE, CAVE, LANDMARK_WHIRL_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_WHIRLISLANDS
	map WhirlIslandLugiaChamber, TILESET_DARK_CAVE, CAVE, LANDMARK_WHIRL_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_WHIRLISLANDS
	map SilverCaveRoom1, TILESET_DARK_CAVE, CAVE, LANDMARK_SILVER_CAVE, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_SILVERCAVE
	map SilverCaveRoom2, TILESET_CAVE, CAVE, LANDMARK_SILVER_CAVE, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_SILVERCAVE
	map SilverCaveRoom3, TILESET_CAVE, CAVE, LANDMARK_SILVER_CAVE, MUSIC_LIGHTHOUSE, TRUE, PALETTE_DAY, FISHGROUP_SILVERCAVE
	map SilverCaveItemRooms, TILESET_CAVE, CAVE, LANDMARK_SILVER_CAVE, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_SILVERCAVE
	map DarkCaveVioletEntrance, TILESET_DARK_CAVE, CAVE, LANDMARK_DARK_CAVE, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_DARKCAVE
	map DarkCaveBlackthornEntrance, TILESET_DARK_CAVE, CAVE, LANDMARK_DARK_CAVE, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_DARKCAVE
	map DarkCaveMoltresChamber, TILESET_DARK_CAVE, CAVE, LANDMARK_DARK_CAVE, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_DARKCAVE
	map DragonsDen1F, TILESET_CAVE, CAVE, LANDMARK_DRAGONS_DEN, MUSIC_DRAGONS_DEN, TRUE, PALETTE_NITE, FISHGROUP_DRAGONSDEN
	map DragonsDenB1F, TILESET_JOHTO, CAVE, LANDMARK_DRAGONS_DEN, MUSIC_DRAGONS_DEN, TRUE, PALETTE_NITE, FISHGROUP_DRAGONSDEN
	map DragonShrine, TILESET_LAB, INDOOR, LANDMARK_DRAGONS_DEN, MUSIC_DRAGONS_DEN, TRUE, PALETTE_NITE, FISHGROUP_DRAGONSDEN
	map TohjoFalls, TILESET_CAVE, CAVE, LANDMARK_TOHJO_FALLS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_TOHJO_FALLS
	...
	map ThunderPeak1F, TILESET_CAVE, CAVE, LANDMARK_THUNDER_PEAK, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_POND
	map ThunderPeakOutside, TILESET_KANTO, ROUTE, LANDMARK_THUNDER_PEAK, MUSIC_ROUTE_3, TRUE, PALETTE_AUTO, FISHGROUP_POND
	map ThunderPeak2F, TILESET_CAVE, CAVE, LANDMARK_THUNDER_PEAK, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_POND
	map CinnabarVolcano1F, TILESET_ELITE_FOUR_ROOM, CAVE, LANDMARK_CINNABAR_VOLCANO, MUSIC_GYM, FALSE, PALETTE_EVE, FISHGROUP_SHORE
	map CinnabarVolcanoB1F, TILESET_ELITE_FOUR_ROOM, CAVE, LANDMARK_CINNABAR_VOLCANO, MUSIC_UNION_CAVE, TRUE, PALETTE_EVE, FISHGROUP_SHORE
	map CinnabarVolcanoB2F, TILESET_ELITE_FOUR_ROOM, CAVE, LANDMARK_CINNABAR_VOLCANO, MUSIC_UNION_CAVE, TRUE, PALETTE_EVE, FISHGROUP_SHORE
	map CinnabarVolcanoB3F, TILESET_ELITE_FOUR_ROOM, CAVE, LANDMARK_CINNABAR_VOLCANO, MUSIC_UNION_CAVE, TRUE, PALETTE_EVE, FISHGROUP_SHORE
	map CianwoodCave1F, TILESET_DARK_CAVE, CAVE, LANDMARK_CIANWOOD_CAVE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_CIANWOODCAVE
	map CianwoodCave2F, TILESET_DARK_CAVE, CAVE, LANDMARK_CIANWOOD_CAVE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_CIANWOODCAVE
	map CianwoodCave3F, TILESET_DARK_CAVE, CAVE, LANDMARK_CIANWOOD_CAVE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_CIANWOODCAVE
	map DragonsDenB2F, TILESET_DARK_CAVE, CAVE, LANDMARK_DRAGONS_DEN, MUSIC_DRAGONS_DEN, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_DRAGONSDEN2
	map SafariZoneEntrance, TILESET_PARK, ROUTE, LANDMARK_SAFARI_ZONE, MUSIC_NATIONAL_PARK, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SafariZoneArea1, TILESET_PARK, ROUTE, LANDMARK_SAFARI_ZONE, MUSIC_NATIONAL_PARK, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SafariZoneArea2, TILESET_PARK, ROUTE, LANDMARK_SAFARI_ZONE, MUSIC_NATIONAL_PARK, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SafariZoneArea3, TILESET_PARK, ROUTE, LANDMARK_SAFARI_ZONE, MUSIC_NATIONAL_PARK, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map CeruleanCave1F, TILESET_DARK_CAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_MEWTWO
	map CeruleanCave2F, TILESET_DARK_CAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_MEWTWO
	map CeruleanCaveB1F, TILESET_DARK_CAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_MEWTWO
	map ViridianForest, TILESET_FOREST, CAVE, LANDMARK_VIRIDIAN_FOREST, MUSIC_NATIONAL_PARK, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SaltmarshArea1, TILESET_PARK, ROUTE, LANDMARK_OLIVINE_SALTMARSH, MUSIC_NATIONAL_PARK, FALSE, PALETTE_AUTO, FISHGROUP_SALTMARSH
	map SaltmarshArea2, TILESET_PARK, ROUTE, LANDMARK_OLIVINE_SALTMARSH, MUSIC_NATIONAL_PARK, FALSE, PALETTE_AUTO, FISHGROUP_SALTMARSH
	map SaltmarshArea3, TILESET_PARK, ROUTE, LANDMARK_OLIVINE_SALTMARSH, MUSIC_NATIONAL_PARK, FALSE, PALETTE_AUTO, FISHGROUP_SALTMARSH
	map SaltmarshArea4, TILESET_PARK, ROUTE, LANDMARK_OLIVINE_SALTMARSH, MUSIC_NATIONAL_PARK, FALSE, PALETTE_AUTO, FISHGROUP_SALTMARSH
...
MapGroup_Ecruteak:
	...
	map EcruteakCity, TILESET_JOHTO, TOWN, LANDMARK_ECRUTEAK_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_ECRUTEAK
...
MapGroup_Blackthorn:
	...
	map BlackthornCity, TILESET_JOHTO, TOWN, LANDMARK_BLACKTHORN_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_BLACKTHORN
...
MapGroup_Cinnabar:
	...
	map SeafoamIslands1F, TILESET_DARK_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_SEAFOAM
	map SeafoamIslandsB1F, TILESET_DARK_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_SEAFOAM
	map SeafoamIslandsB2F, TILESET_DARK_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_SEAFOAM
	map SeafoamIslandsB3F, TILESET_DARK_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_SEAFOAM
	map SeafoamIslandsB4F, TILESET_DARK_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_SEAFOAM
	map Route19, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_19, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_ROUTE19
	map Route20, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_20, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_ROUTE20
	map Route21, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_21, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_ROUTE21
	map CinnabarIsland, TILESET_KANTO, TOWN, LANDMARK_CINNABAR_ISLAND, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_CINNABARCITY
...
MapGroup_Cerulean:
	...
	map Route4, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_4, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_CERULEANCITY
	map Route9, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_9, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_ROUTE9
	map Route10North, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_10, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_ROUTE10
	map Route24, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_24, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_CERULEANCITY
	map Route25, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_25, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_CERULEANCITY
	map CeruleanCity, TILESET_KANTO, TOWN, LANDMARK_CERULEAN_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_CERULEANCITY
...
MapGroup_LakeOfRage:
	...
	map Route43, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_43, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_ROUTE43
	map LakeOfRage, TILESET_JOHTO, TOWN, LANDMARK_LAKE_OF_RAGE, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_LAKEOFRAGE
	assert_table_length NUM_LAKE_OF_RAGE_MAPS

MapGroup_Violet:
	table_width MAP_LENGTH
	map Route32, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_32, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_ROUTE32
	map Route35, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_35, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_ROUTE35
	...
	map VioletCity, TILESET_JOHTO, TOWN, LANDMARK_VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_VIOLETCITY
	map VioletMart, TILESET_MART, INDOOR, LANDMARK_VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_VIOLETCITY
...
MapGroup_Goldenrod:
	table_width MAP_LENGTH
	map Route34, TILESET_JOHTO_MODERN, ROUTE, LANDMARK_ROUTE_34, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_ROUTE34
...
MapGroup_Vermilion:
	table_width MAP_LENGTH
	map Route6, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_6, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_ROUTE6
	map Route11, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_11, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map VermilionCity, TILESET_KANTO, TOWN, LANDMARK_VERMILION_CITY, MUSIC_VERMILION_CITY, FALSE, PALETTE_AUTO, FISHGROUP_VERMILION
...
MapGroup_Fuchsia:
	...
	map FuchsiaCitySafariGate, TILESET_GATE, GATE, LANDMARK_FUCHSIA_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Silver:
	table_width MAP_LENGTH
	map Route28, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_28, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_AUTO, FISHGROUP_ROUTE28
	map SilverCaveOutside, TILESET_KANTO, TOWN, LANDMARK_SILVER_CAVE, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_AUTO, FISHGROUP_SILVERCAVE
...
MapGroup_Celadon:
	...
	map Route17, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_17, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_ROUTE17
...
MapGroup_Cianwood:
	table_width MAP_LENGTH
	map Route40, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_40, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_ROUTE40
	map Route41, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_41, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_ROUTE41
	map CianwoodCity, TILESET_JOHTO, TOWN, LANDMARK_CIANWOOD_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_CIANWOOD
	...
	map Route40SaltmarshGate, TILESET_GATE, GATE, LANDMARK_OLIVINE_SALTMARSH, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Viridian:
	...
	map Route22, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_22, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_ROUTE22
...
MapGroup_NewBark:
	table_width MAP_LENGTH
	map Route26, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_26, MUSIC_ROUTE_26, FALSE, PALETTE_AUTO, FISHGROUP_ROUTE26
	map Route27, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_27, MUSIC_ROUTE_26, FALSE, PALETTE_AUTO, FISHGROUP_ROUTE27
	map Route29, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_29, MUSIC_ROUTE_29, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map NewBarkTown, TILESET_JOHTO, TOWN, LANDMARK_NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_NEWBARK
...
MapGroup_Cherrygrove:
	table_width MAP_LENGTH
	map Route30, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_30, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_ROUTE30
	map Route31, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_31, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_ROUTE31
	map CherrygroveCity, TILESET_JOHTO, TOWN, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_CHERRYGROVE
...
MapGroup_PokeChampionClub:
	table_width MAP_LENGTH
	map PokeChampionClubOutside, TILESET_JOHTO_MODERN, ROUTE, LANDMARK_CHAMPION_CLUB, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map PokeChampionClubInside, TILESET_RADIO_TOWER, INDOOR, LANDMARK_CHAMPION_CLUB, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_POKE_CHAMPION_CLUB_MAPS
