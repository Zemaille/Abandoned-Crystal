...
; BATTLE_ANIM_OBJ_DAZZLE
	battleanimobj RELATIVE_X, $90, BATTLE_ANIM_FRAMESET_SPARKLE, BATTLE_ANIM_FUNC_HIDDEN_POWER, PAL_BATTLE_OB_YELLOW, $11
...
; BATTLE_ANIM_OBJ_ICICLE
	battleanimobj RELATIVE_X, $ff, BATTLE_ANIM_FRAMESET_ICICLE_CRASH, BATTLE_ANIM_FUNC_DROP, PAL_BATTLE_OB_BLUE, BATTLE_ANIM_GFX_ICICLE_CRASH
; BATTLE_ANIM_OBJ_ICICLE
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $90, BATTLE_ANIM_FRAMESET_HORN, BATTLE_ANIM_FUNC_HORN, PAL_BATTLE_OB_BLUE, $1d	
; ANIM_OBJ_MEDIUM_HORN
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $90, BATTLE_ANIM_FRAMESET_MEDIUM_HORN, BATTLE_ANIM_FUNC_NEEDLE, PAL_BATTLE_OB_BLUE, BATTLE_ANIM_GFX_HORN
