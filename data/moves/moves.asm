...
MovesGen1:
	...
	move EFFECT_DEFENSE_DOWN_HIT,   50, STEEL,         PHYSICAL,  95, 30,  20      ;CUT
	...
	move EFFECT_RECOIL_HIT,        120, NORMAL,        STATUS,   100, 15,   0      ;DOUBLE_EDGE
	...
	move EFFECT_ATTACK_UP_HIT,      80, NORMAL,        PHYSICAL, 100, 15,  10      ;STRENGTH
	...
	move EFFECT_LEECH_HIT,          60, BUG,           PHYSICAL, 100, 10,   0      ;LEECH_LIFE
	...
	move EFFECT_PARALYZE_HIT,       20, ELECTRIC,      SPECIAL,  100, 20, 100      ;FLASH
	move EFFECT_PSYWAVE,             1, PSYCHIC_TYPE,  SPECIAL,  100, 15,   0      ;PSYWAVE
	...
	move EFFECT_SELFDESTRUCT,      250, NORMAL,        PHYSICAL, 100,  1,   0      ;EXPLOSION
	...
	move EFFECT_FLINCH_HIT,         75, ROCK,          PHYSICAL, 100, 10,  30      ;ROCK_SLIDE
...
MovesGen2:
	...
	move EFFECT_NORMAL_HIT,        100, FLYING,        SPECIAL,  100,  5,   0      ;AEROBLAST
	...
	move EFFECT_FUTURE_SIGHT,      120, PSYCHIC_TYPE,  SPECIAL,   90, 15,   0      ;FUTURE_SIGHT
	move EFFECT_DEFENSE_DOWN_HIT,   40, FIGHTING,      PHYSICAL, 100, 15, 100      ;ROCK_SMASH
...
MovesGen3:
	...
	move EFFECT_ALWAYS_HIT,         60, FLYING,        PHYSICAL, 100, 15,   0      ;Aerial Ace
	...
	move EFFECT_SELF_SP_ATK_DROP,  130, FAIRY,         SPECIAL,   90,  5,   0      ;Starblast
	...
	move EFFECT_POISON_HIT,         80, POISON,        PHYSICAL, 100, 20,  30      ;Poison Jab
