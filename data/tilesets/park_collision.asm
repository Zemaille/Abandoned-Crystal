	...
	tilecoll WARP_CARPET_DOWN, WARP_CARPET_DOWN, WALL, WALL ; 70
	tilecoll WALL, WALL, WARP_CARPET_UP, WARP_CARPET_UP ; 71
	tilecoll WARP_CARPET_RIGHT, WALL, WARP_CARPET_RIGHT, WALL ; 72
	tilecoll WALL, WARP_CARPET_LEFT, WALL, WARP_CARPET_LEFT ; 73
