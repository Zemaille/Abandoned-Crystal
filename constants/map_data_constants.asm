...
;---------------------------------------------------------------------------------
	...
	const FISHGROUP_DARKCAVE
	const FISHGROUP_VIOLETCITY
	const FISHGROUP_RUINSOFALPH
	const FISHGROUP_ROUTE32
	const FISHGROUP_UNIONCAVE
	const FISHGROUP_SLOWPOKEWELL
	const FISHGROUP_ILEXFOREST
	const FISHGROUP_ROUTE34
	const FISHGROUP_ROUTE35
	const FISHGROUP_ROUTE42
	const FISHGROUP_OLIVINECITY
	const FISHGROUP_SALTMARSH
	...
	const FISHGROUP_CIANWOODCAVE
	const FISHGROUP_ROUTE28
	const FISHGROUP_SILVERCAVE
	const FISHGROUP_ROUTE22
	const FISHGROUP_ROUTE6
	const FISHGROUP_VERMILION
	const FISHGROUP_ROUTE17
	const FISHGROUP_ROUTE19
	const FISHGROUP_ROUTE20
	const FISHGROUP_ROUTE21
	const FISHGROUP_ROUTE9
	const FISHGROUP_ROUTE10
	const FISHGROUP_CERULEANCITY
	const FISHGROUP_CINNABARCITY
	const FISHGROUP_WHIRLISLANDS
	const FISHGROUP_SEAFOAM
	const FISHGROUP_MEWTWO
	const FISHGROUP_DRAGONSDEN
	const FISHGROUP_MOUNT_MORTAR
	const FISHGROUP_DRAGONSDEN2
	const FISHGROUP_TOHJO_FALLS
