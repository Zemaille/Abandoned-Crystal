...
DEF MT01 EQU const_value
	add_mt FIRE_BLAST	;MT01_MOVE
	add_mt THUNDER		;MT02_MOVE
	add_mt BLIZZARD		;MT03_MOVE
	add_mt FIRE_FANG	;MT04_MOVE
	add_mt ICE_FANG		;MT05_MOVE
	add_mt THUNDER_FANG ;MT06_MOVE
	add_mt FIRE_PUNCH	;MT07_MOVE
	add_mt THUNDERPUNCH ;MT08_MOVE
	add_mt ICE_PUNCH	;MT09_MOVE
	add_mt SUBSTITUTE	;MT10_MOVE
	add_mt DRACO_METEOR ;MT11_MOVE
