...
; Fisher
	...
	const EVENT_BEAT_FISHER_QUINTIN
; Twins
...
; Guitarist
	...
	const EVENT_BEAT_GUITARIST_WPC
; Juggler
...
; Blackbelt
	...
	const EVENT_BEAT_BLACKBELT_AKIRA
; Beauty
...
; Pokemaniac
	...
	const EVENT_BEAT_POKEMANIAC_JEREMIAH
; GruntM
...
; Bug Catcher
	...
	const EVENT_BEAT_BUG_CATCHER_HARV
; Officer
	const EVENT_BEAT_OFFICER_KEITH
	const EVENT_BEAT_OFFICER_DIRK
	const EVENT_BEAT_OFFICER_DICK
; CooltrainerM
...
; CooltrainerF
	...
	const EVENT_BEAT_COOLTRAINERF_SHAY
; ExecutiveF
...
; Teacher
	...
	const EVENT_BEAT_TEACHER_RACHEL
...
; Johto people
	...
	const EVENT_ILEX_FOREST_HEART_VOLTORB
...
; Ilex Forest Heart (Voltorb event is elsewere in this file)
	const EVENT_ILEX_FOREST_HEART_PP_UP
	const EVENT_ILEX_FOREST_HEART_BERSERK_GENE
	const EVENT_ILEX_FOREST_HEART_LEAF_STONE
	const EVENT_ILEX_FOREST_HEART_HATCHET
	const EVENT_ILEX_FOREST_HEART_HIDDEN_BIG_NUGGET
	const EVENT_ILEX_FOREST_HEART_HIDDEN_PROTEIN
	const EVENT_ILEX_FOREST_HEART_HIDDEN_ULTRA_BALL

; Dark Cave
	const EVENT_DARK_CAVE_BLACKTHORN_ENTRANCE_MASTER_BALL
	const EVENT_DARK_CAVE_MOLTRES_CHAMBER_MOLTRES_G
	
; Thunder Peak
	const EVENT_THUNDER_PEAK_2F_ZAPDOS
	const EVENT_THUNDER_PEAK_OUTSIDE_THUNDERSTONE
	const EVENT_THUNDER_PEAK_OUTSIDE_METAL_COAT
	const EVENT_THUNDER_PEAK_1F_FULL_RESTORE
	const EVENT_THUNDER_PEAK_1F_BIG_NUGGET
	const EVENT_THUNDER_PEAK_1F_HIDDEN_BERSERK_GENE
	
; Cinnabar Volcano
	const EVENT_CINNABAR_VOLCANO_B1F_MAX_REVIVE
	const EVENT_CINNABAR_VOLCANO_B1F_BIG_NUGGET
	const EVENT_CINNABAR_VOLCANO_B2F_FIRE_STONE
	const EVENT_CINNABAR_VOLCANO_B2F_PP_UP
	const EVENT_CINNABAR_VOLCANO_MOLTRES
	
; Seafoam Islands
	const EVENT_SEAFOAM_ISLANDS_B4F_ARTICUNO
	const EVENT_SEAFOAM_ISLANDS_B4F_PP_UP
	const EVENT_SEAFOAM_ISLANDS_B3F_WATER_STONE
	const EVENT_SEAFOAM_ISLANDS_B3F_BERSERK_GENE
	const EVENT_SEAFOAM_ISLANDS_B3F_HIDDEN_BIG_NUGGET
	const EVENT_SEAFOAM_ISLANDS_B2F_HIDDEN_CARBOS
	const EVENT_SEAFOAM_ISLANDS_B2F_BIG_NUGGET
	const EVENT_SEAFOAM_ISLANDS_B2F_FULL_RESTORE
	const EVENT_SEAFOAM_ISLANDS_B2F_MASTER_BALL
	const EVENT_SEAFOAM_ISLANDS_B1F_WATER_STONE
	const EVENT_SEAFOAM_ISLANDS_B1F_MYSTIC_WATER
	const EVENT_SEAFOAM_ISLANDS_B1F_IRON
	const EVENT_SEAFOAM_ISLANDS_1F_ZINC
	const EVENT_SEAFOAM_ISLANDS_1F_KINGS_ROCK
	const EVENT_SEAFOAM_ISLANDS_1F_MIRACLEBERRY

; Cianwood Cave
	const EVENT_CIANWOOD_CAVE_2F_MAX_ELIXER
	const EVENT_CIANWOOD_CAVE_2F_MAX_POTION
	const EVENT_CIANWOOD_CAVE_2F_HIDDEN_PP_UP
	const EVENT_CIANWOOD_CAVE_3F_KINGS_ROCK
	const EVENT_CIANWOOD_CAVE_3F_BIRD_WHISTLE
	const EVENT_CIANWOOD_CAVE_3F_ZAPDOS_G

; Whirl Island Lugia Chamber
	const EVENT_WHIRL_ISLAND_LUGIA_CHAMBER_WATER_STONE
	const EVENT_WHIRL_ISLAND_LUGIA_CHAMBER_PP_UP
	const EVENT_WHIRL_ISLAND_LUGIA_CHAMBER_BIG_NUGGET
	const EVENT_WHIRL_ISLAND_LUGIA_CHAMBER_VORTEXDRIVE
	
; Ice Path Depths
	const EVENT_ICE_PATH_DEPTHS_ARTICUNOG
	const EVENT_ICE_PATH_DEPTHS_PP_UP
	const EVENT_ICE_PATH_DEPTHS_ICE_STONE
	const EVENT_ICE_PATH_DEPTHS_HIDDEN_MASTER_BALL

; Dragon's Den B2F
	const EVENT_DRAGONS_DEN_B2F_KINGS_ROCK
	const EVENT_DRAGONS_DEN_B2F_BIG_NUGGET
	const EVENT_DRAGONS_DEN_B2F_PROTEIN
	const EVENT_DRAGONS_DEN_B2F_HYDRO_BOOST

; Safari Zone
	const EVENT_SAFARI_ZONE_ENTRACE_LEAF_STONE
	const EVENT_SAFARI_ZONE_AREA_1_MOON_STONE
	const EVENT_SAFARI_ZONE_AREA_1_REVIVAL_HERB
	const EVENT_SAFARI_ZONE_AREA_2_BIG_NUGGET
	const EVENT_SAFARI_ZONE_AREA_3_BERRY
	const EVENT_SAFARI_ZONE_AREA_3_MIRACLEBERRY
	const EVENT_SAFARI_ZONE_AREA_3_MEW
	
; Cerulean Cave
	const EVENT_CERULEAN_CAVE_1F_ULTRA_BALL
	const EVENT_CERULEAN_CAVE_1F_MAX_REVIVE
	const EVENT_CERULEAN_CAVE_2F_HP_UP
	const EVENT_CERULEAN_CAVE_2F_PROTEIN
	const EVENT_CERULEAN_CAVE_2F_IRON
	const EVENT_CERULEAN_CAVE_2F_CARBOS
	const EVENT_CERULEAN_CAVE_2F_CALCIUM
	const EVENT_CERULEAN_CAVE_2F_ZINC
	const EVENT_CERULEAN_CAVE_B1F_MOON_STONE
	const EVENT_CERULEAN_CAVE_B1F_MEWTWO

; Olivine Saltmarsh
	const EVENT_SALTMARSH_AREA_1_POKE_BALL
	const EVENT_SALTMARSH_AREA_1_ENERGY_ROOT
	const EVENT_SALTMARSH_AREA_1_HIDDEN_NUGGET
	const EVENT_SALTMARSH_AREA_2_BIG_PEARL
	const EVENT_SALTMARSH_AREA_2_HIDDEN_LEAF_STONE
	const EVENT_SALTMARSH_AREA_3_ENERGY_ROOT
	const EVENT_SALTMARSH_AREA_3_MAX_ELIXER
	const EVENT_SALTMARSH_AREA_3_PP_UP
	const EVENT_SALTMARSH_AREA_4_LOCH_FLUTE
	const EVENT_SALTMARSH_AREA_4_BRIGHTPOWDER
	const EVENT_SALTMARSH_AREA_4_LEFTOVERS
...
; Kimono Girls +3
	const EVENT_BEAT_KIMONO_GIRL_KIRA
	const EVENT_BEAT_KIMONO_GIRL_SHINO
	const EVENT_BEAT_KIMONO_GIRL_MOMO

; Inserts
	const EVENT_BEAT_LAZY_DEV_ZEM
	const EVENT_BEAT_HIKERMATT_MATT
	const EVENT_BEAT_WEEB_GOLIRA
	const EVENT_BEAT_SKIER_ELISE
	const EVENT_BEAT_SAILOR_PETCHEL
