...
; BattleAnimObjects indexes (see data/battle_anims/objects.asm)
	...
	const BATTLE_ANIM_OBJ_FOCUS_BLAST
	...
	const BATTLE_ANIM_OBJ_ENERGY_BALL
	const BATTLE_ANIM_OBJ_SPARKS_CIRCLE
	const BATTLE_ANIM_OBJ_GUNKSHOT
	const BATTLE_ANIM_OBJ_THUNDERBOLT_BALL
	const BATTLE_ANIM_OBJ_ICICLE_CRASH
	const BATTLE_ANIM_OBJ_POWER_GEM
	const BATTLE_ANIM_OBJ_STONE_EDGE
	const BATTLE_ANIM_OBJ_SHELL_SMASH_DEBRIS
	const BATTLE_ANIM_OBJ_SHELL_SMASH_SHELL
	const BATTLE_ANIM_OBJ_SHELL_SMASH_HIT
...
; DoBattleAnimFrame arguments (see engine/battle_anims/functions.asm)
	...
	const BATTLE_ANIM_FUNC_MOON                               ; 5b
	const BATTLE_ANIM_FUNC_POWER_GEM
...
; BattleAnimFrameData indexes (see data/battle_anims/framesets.asm)
	...
	const BATTLE_ANIM_FRAMESET_NEW_BLAST			   ; 101
	const BATTLE_ANIM_FRAMESET_ICICLE_CRASH            ; 102
	const BATTLE_ANIM_FRAMESET_STONE_EDGE			   ; 103
...
; AnimObjGFX indexes (see data/battle_anims/object_gfx.asm)
	...
	const BATTLE_ANIM_GFX_MOON             ; 44
	const BATTLE_ANIM_GFX_ICICLE_CRASH     ; 44
