...
LakeOfRageTMDetect:
	itemball TM_BUG_BUZZ

LakeOfRageHiddenFullRestore:
	hiddenitem FULL_RESTORE, EVENT_LAKE_OF_RAGE_HIDDEN_FULL_RESTORE

LakeOfRageHiddenRareCandy:
	hiddenitem BIG_NUGGET, EVENT_LAKE_OF_RAGE_HIDDEN_RARE_CANDY
...
LakeOfRage_MapEvents:
	...
	def_object_events
	object_event 21, 28, SPRITE_KAREN, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, LakeOfRageLanceScript, EVENT_LAKE_OF_RAGE_LANCE
