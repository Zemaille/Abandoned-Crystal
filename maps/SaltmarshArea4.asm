...
SaltmarshArea4_MapEvents:
	...
	def_object_events
	object_event  7,  2, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, SaltmarshArea4LochFluteScript, EVENT_SALTMARSH_AREA_4_LOCH_FLUTE
