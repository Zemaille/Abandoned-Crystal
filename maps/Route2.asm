...
Route2_MapEvents:
	...
	warp_event  4, 33, VIRIDIAN_FOREST, 1
	warp_event  2, 11, VIRIDIAN_FOREST, 3
	warp_event  3, 11, VIRIDIAN_FOREST, 3
	...
	bg_event  5, 36, BGEVENT_ITEM, Route2HiddenMaxEther
	bg_event  4, 36, BGEVENT_ITEM, Route2HiddenFullHeal
	bg_event  7, 36, BGEVENT_ITEM, Route2HiddenFullRestore
	bg_event  6, 36, BGEVENT_ITEM, Route2HiddenRevive
	...
	object_event  0, 36, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route2DireHit, EVENT_ROUTE_2_DIRE_HIT
	object_event  1, 36, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route2MaxPotion, EVENT_ROUTE_2_MAX_POTION
	...
	object_event  2, 36, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route2FruitTree, -1
